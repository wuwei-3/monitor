...
export default {
  ...
  data () {
    return {
      ...
      column: [
        { label: "IP", prop: "IP" },
        { label: "GTID MODE", prop: "gtid_mode" },
        { label: "READ ONLY", prop: "read_only" },
        { label: "MASTER SERVER", prop: "master_server" },
        { label: "MASTER PORT", prop: "master_port" },
        { label: "SLAVE IO RUN", prop: "gtid_mode" },
        { label: "SLAVE SQL RUN", prop: "slave_io_run" },
        { label: "VALUE", prop: "slave_sql_run" },
        { label: "DELAY", prop: "delay" },
        { label: "CURRENT BINLOG FILE", prop: "current_binlog_file" },
        { label: "CURRENT BINLOG POS", prop: "current_binlog_pos" },
        { label: "MASTER BINLOG FILE", prop: "master_binlog_file" },
        { label: "MASTER BINLOG POS", prop: "master_binlog_pos" },
