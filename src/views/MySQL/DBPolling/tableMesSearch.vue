<template>
  ...
  <div class="tableMesSearch">
    <div class="e-top">
      ...
      <div class="w100 r10">
        <el-input v-model="file.tableName"
                  placeholder="请输入分区表名"></el-input>
      </div>
      <div class="p-select">
...
import { queryIMSegmentInfo } from "@/api/sqlManager";
export default {
  components: {
    aSelet,
    nTable,
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "TABLE_SCHEMA", prop: "TABLE_SCHEMA" },
        { label: "TABLE_NAME", prop: "TABLE_NAME" },
        { label: "PARTITION_NAME", prop: "PARTITION_NAME" },
        { label: "SUBPARTITION_NAME", prop: "SUBPARTITION_NAME" },
        { label: "TABLE_ROWS", prop: "TABLE_ROWS" },
        { label: "DATA_LENGTH", prop: "DATA_LENGTH" },
        { label: "INDEX_LENGTH", prop: "INDEX_LENGTH" },
        { label: "DATA_FREE", prop: "DATA_FREE" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
