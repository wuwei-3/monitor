...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式ssss
      column: [
        { label: "DATADIR", prop: "datadir" },
        { label: "INNODB DATA FILE PATH", prop: "innodb_data_file_path" },
        { label: "INNODB TEMP DATA FILE PATH", prop: "innodb_temp_data_file_path" }
      ],
      tableData: [],
      loading: false,
      file: {
