  ...
  <div class="m-monitor">
    ...
    <div v-if="delVisable">
      <a-delete :visible="delVisable"
                ...
                :status="5"
                :title="'删除监控'"
                :content="delName.length  == tableData.length?'确定要删除全部监控项配置？':'确当要删除监控项配置？'"></a-delete>
    </div>
  </div>
</template>
...
import { monitorPage } from "@/api/Oracle.js";
