...
import { BufferHitRate } from "@/api/sqlMonitor";
export default {
  components: {
    aSelet,
    nTable,
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "PHYSICAL_READS", prop: "PHYSICAL_READS" },
        { label: "DB_BLOCK_GETS", prop: "DB_BLOCK_GETS" },
        { label: "CONSISTENT_GETS", prop: "CONSISTENT_GETS" },
        { label: "HIT_RATIO", prop: "HIT_RATIO" }
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
