...
import { HigeVersionSQL } from "@/api/sqlMonitor";
...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "SQL_ID", prop: "SQL_ID", width: 10 },
        { label: "EXECUTIONS", prop: "EXECUTIONS", width: 10 },
        { label: "VERSION_COUNT", prop: "VERSION_COUNT", width: 10 },
        { label: "USERS_OPENING", prop: "USERS_OPENING", width: 10 },
        { label: "SQL TEXT", prop: "SQL_TEXT", width: 50 },
        { label: "执行计划", prop: "operaton1", type: 1, width: 10 }
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
