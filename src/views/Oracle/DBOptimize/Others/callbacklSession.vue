...
import { queryRollbackSegmentSession } from "@/api/sqlMonitor";
...
export default {
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "CR_GET", prop: "CR_GET" },
        { label: "PHY_IO", prop: "PHY_IO" },
        { label: "USED_UBLK", prop: "USED_UBLK" },
        { label: "NOUNDO", prop: "NOUNDO" },
  ...
  methods: {
    ...
    getMes (val) {
      this.loading = true;
      let _self = this;
      queryRollbackSegmentSession(val)
        .then(result => {
