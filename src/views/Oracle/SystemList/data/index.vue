  ...
  data () {
    return {
      titleColumn: [
        ...
        { label: "ORACLE_HOME", prop: "ORACLE_HOME", width: 10 },
        { label: "CDB_TYPE", prop: "CDB_TYPE", width: 10 },
        { label: "实例类型", prop: "实例类型", width: 10 },
        { label: "操作", prop: "operato", width: 10 } //普通 操作 修改删除
      ],
      titleDate: [],
      delName: [],
      List: [],
