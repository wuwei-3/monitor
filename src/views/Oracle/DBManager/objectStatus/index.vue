...
import { queryIMObjectState } from "@/api/sqlManager";
export default {
  components: {
    aSelet,
    nTable,
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "INMEMORY", prop: "INMEMORY" },
        { label: "INMEMORY_PRIORITY", prop: "INMEMORY_PRIORITY" },
        { label: "INMEMORY_DISTRIBUTE", prop: "INMEMORY_DISTRIBUTE" },
        { label: "INMEMORY_COMPRESSION", prop: "INMEMORY_COMPRESSION" },
        { label: "INMEMORY_DUPLICATE", prop: "INMEMORY_DUPLICATE" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
