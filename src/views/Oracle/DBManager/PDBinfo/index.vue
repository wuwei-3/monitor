    ...
    <div class="e-bot"
      ...
      <div>
        <n-table :column="column"
                 ...
                 :status="'sql1'"
                 :selection="'1'"
                 @profileUpdate='profileUpdate'></n-table>
      </div>
    </div>
    <div v-if="visible">
...
import { queryPDBInfo } from "@/api/sqlManager";
export default {
  components: {
    aSelet,
    nTable,
