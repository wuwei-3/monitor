...
import { queryDBUserState } from "@/api/sqlManager";
export default {
  components: {
    aSelet,
    nTable,
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "DEFAULT_TABLESPACE", prop: "DEFAULT_TABLESPACE" },
        { label: "TEMP_TABLESPACE", prop: "TEMP_TABLESPACE" },
        { label: "CREATED_DATE", prop: "CREATED_DATE" },
        { label: "ACCOUNT_STATUS", prop: "ACCOUNT_STATUS" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
