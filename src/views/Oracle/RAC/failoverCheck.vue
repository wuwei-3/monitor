...
import { failoverCheck } from "@/api/rac";
...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "FAILOVER_TYPE", prop: "FAILOVER_TYPE" },
        { label: "FAILOVER_METHOD", prop: "FAILOVER_METHOD" },
        { label: "FAILED_OVER", prop: "FAILED_OVER" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
