...
import { queryDiskGroupRebalanceState } from "@/api/rac";
...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "GROUP_NUMBER", prop: "GROUP_NUMBER" },
        { label: "ENTRY_NUMBER", prop: "ENTRY_NUMBER" },
        { label: "REDUNDANCY", prop: "REDUNDANCY" },
        { label: "STRIPE", prop: "STRIPE" },
        { label: "SYSTEM", prop: "SYSTEM" },
        { label: "NAME", prop: "NAME" },
        { label: "PRIMARY_REGION", prop: "PRIMARY_REGION" },
        { label: "MIRROR_REGION", prop: "MIRROR_REGION" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
  ...
  methods: {
    ...
    getMes (val) {
      this.loading = true;
      let _self = this;
      queryDiskGroupRebalanceState(val)
        .then(result => {
