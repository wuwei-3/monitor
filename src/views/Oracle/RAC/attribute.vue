...
import { queryDiskGroupAttribute } from "@/api/rac";
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "OPER", prop: "OPER" },
        { label: "SECTOR_SIZE", prop: "SECTOR_SIZE" },
        { label: "BLOCK_SIZE", prop: "BLOCK_SIZE" },
        { label: "AUSIZE", prop: "AUSIZE" },
        { label: "TOTAL_MB", prop: "TOTAL_MB" },
        { label: "FREE_MB", prop: "FREE_MB" },
        { label: "REQUIRED_MIRROR_FREE_MB", prop: "REQUIRED_MIRROR_FREE_MB" },
        { label: "USABLE_FILE_MB", prop: "USABLE_FILE_MB" },
        { label: "OFFLINE_DISKS", prop: "OFFLINE_DISKS" },
        { label: "VOTING_FILES", prop: "VOTING_FILES" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
