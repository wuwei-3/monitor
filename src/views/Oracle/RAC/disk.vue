  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "DISK_NUMBER", prop: "DISK_NUMBER" },
        { label: "DISKGROUP_NAME", prop: "DISKGROUP_NAME" },
        { label: "MODE_STATUS", prop: "MODE_STATUS" },
        { label: "TOTAL_MB", prop: "TOTAL_MB" },
        { label: "FREE_MB", prop: "FREE_MB" },
        { label: "OS_MB", prop: "OS_MB" },
        { label: "DISK_NAME", prop: "DISK_NAME" },
        { label: "FAILGROUP", prop: "FAILGROUP" },
