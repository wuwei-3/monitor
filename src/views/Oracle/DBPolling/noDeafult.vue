...
import { queryNonDefaultParam } from "@/api/DBPolling";
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "DISPLAY_VALUE", prop: "DISPLAY_VALUE" },
        { label: "ISDEFAULT", prop: "ISDEFAULT" },
        { label: "ISSYS_MODIFIABLE", prop: "ISSYS_MODIFIABLE" },
