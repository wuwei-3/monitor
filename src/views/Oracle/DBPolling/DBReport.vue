...
import { createInspectionReport, downloadInspectionReport } from "@/api/DBPolling";
...
export default {
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "CURRENT_SIZE", prop: "CURRENT_SIZE" },
        { label: "MIN_SIZE", prop: "MIN_SIZE" },
        { label: "MAX_SIZE", prop: "MAX_SIZE" },
        { label: "OPER_COUNT", prop: "OPER_COUNT" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
  ...
  methods: {
    ...
    downloadDb () {
      this.loading = true
      downloadInspectionReport({ id: this.file.id }).then((result) => {
