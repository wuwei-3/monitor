...
import { queryIndexHealthExamination } from "@/api/DBPolling";
...
export default {
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "PART_NAME", prop: "PART_NAME" },
        { label: "SUBPART_NAME", prop: "SUBPART_NAME" },
        { label: "DENSITY", prop: "DENSITY" },
        { label: "EXTRA_BLOCKS", prop: "EXTRA_BLOCKS" },
        { label: "LAST_DDL_TIME", prop: "LAST_DDL_TIME" },
        { label: "LAST_ANALYZED", prop: "LAST_ANALYZED" },
        { label: "COMPRESSION", prop: "COMPRESSION" },
        { label: "操作", prop: "operaton8" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
  ...
  methods: {
    ...
    getMes (val) {
      this.loading = true;
      let _self = this;
      queryIndexHealthExamination(val)
        .then(result => {
