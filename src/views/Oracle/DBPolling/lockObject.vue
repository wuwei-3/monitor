...
import { queryObjectLock } from "@/api/DBPolling";
...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "HOLD_SERIAL", prop: "HOLD_SERIAL" },
        { label: "HOLD_SID", prop: "HOLD_SID" },
        { label: "WAIT_SID", prop: "WAIT_SID" },
        { label: "TYPE", prop: "TYPE" },
        { label: "HOLD", prop: "HOLD" },
        { label: "REQUEST", prop: "REQUEST" },
        { label: "ID1", prop: "ID1" },
        { label: "ID2", prop: "ID2" },
        { label: "CTIME", prop: "CTIME" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
