...
import { queryInstanceEfficiency } from "@/api/DBPolling";
...
export default {
  ...
  data () {
    return {
      ...
      // 统一表格样式
      column: [
        { label: "Buffer Nowait %", prop: "BufferNowait" },
        { label: "Redo NoWait %", prop: "RedoNoWait" },
        { label: "Buffer Hit %", prop: "BufferHit" },
        { label: "In-memory Sort %", prop: "InmemorySort" },
        { label: "Library Hit %", prop: "LibraryHit" },
        { label: "Soft Parse %", prop: "SoftParse" },
        { label: "Execute to Parse %", prop: "ExecutetoParse" },
        { label: "Latch Hit %", prop: "LatchHit" },
        { label: "Parse CPU to Parse Elapsd %", prop: "ParseCPUtoParseElapsd" },
        { label: "% Non-Parse CPU", prop: "NonParseCPU" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
