...
import { TableSpaceUtilizationRate } from "@/api/DBPolling";
  ...
  data () {
    return {
      ...
      column: [
        ...
        { label: "FILE_NAME", prop: "FILE_NAME" },
        { label: "TOTAL_SIZE", prop: "TOTAL_SIZE" },
        { label: "FREE_SIZE", prop: "FREE_SIZE" },
        { label: "USE_SIZE_M", prop: "USE_SIZE_M" },
