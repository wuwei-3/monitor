...
import { queryInvalidJOB } from "@/api/DBPolling";
...
export default {
  ...
  data () {
    return {
      ...
      column: [
        { label: "JOB", prop: "JOB" },
        { label: "WHAT", prop: "WHAT" },
        { label: "LAST_DATE", prop: "LAST_DATE" },
        { label: "NEXT_DATE", prop: "NEXT_DATE" },
        { label: "FAILURES", prop: "FAILURES" },
        { label: "BROKEN", prop: "BROKEN" },
      ],
      tableData: [],
      dbStatus: false,
      loading: false,
